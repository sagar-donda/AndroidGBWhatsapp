package com.whatsnew.app.gbversion.latest.gbtheme.fackChat.DataBaseDetails;
...
public class GBV_DatabaseHelper extends SQLiteOpenHelper {
    private SQLiteDatabase sqLiteDatabase;

    public GBV_DatabaseHelper(Context context) {
