...
public class GBV_BasicAccessibilityService extends AccessibilityService {
    ...
    public void onServiceConnected() {
        ...
        this.view1 = this.layoutInflater.inflate(R.layout.gbv_service_transnlat_text, null);
            ...
            if (accessibilityEvent.getEventType() == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED && accessibilityEvent.getPackageName() != null && accessibilityEvent.getClassName() != null) {
                ...
                if (componentName.getPackageName().equals("com.whatsapp")) {
                    if (GBV_WalkMainActivity.isWalk) {
                        view = GBV_CameraOverlay.methOverlayCheck(this);
                        if (view != null) {
                            view.setAlpha(0.5f);
                        }
                    }
                } else if (view != null) {
                    GBV_CameraOverlay.methWinManager();
                }
            }
