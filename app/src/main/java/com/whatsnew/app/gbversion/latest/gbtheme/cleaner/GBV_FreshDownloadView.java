...
public class GBV_FreshDownloadView extends View {
    ...
    public GBV_FreshDownloadView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GBV_FreshDownloadView(Context context, AttributeSet attrs, int defStyleAttr) {
