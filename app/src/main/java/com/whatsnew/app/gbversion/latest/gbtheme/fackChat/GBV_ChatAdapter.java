...
class GBV_ChatAdapter extends BaseAdapter {
    ...
    public GBV_ChatAdapter(Context context, ArrayList<String> messageArray, ArrayList<String> senderUser, ArrayList<String> time, ArrayList<String> msgstatuslist, ArrayList<String> ismessagetype, ArrayList<String> imagpath) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        @SuppressLint("ViewHolder") View rowView = inflater.inflate(R.layout.gbv_custlistview, null);
        ...
        if (this.ismessagetype.get(i).equals("yes")) {
            ...
            Log.d("--error---", "getView: " + imagpath.get(i));
