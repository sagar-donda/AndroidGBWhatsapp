...
public class GBV_CameraOverlay extends TextureView implements SurfaceTextureListener {
    static GBV_CameraOverlay objCamOverlay;
    static WindowManager windowManager;
    Camera camera;

    public GBV_CameraOverlay(Context context) {
        super(context);
    ...
    public static View methOverlayCheck(Context context) {
        ...
        if (objCamOverlay == null) {
            objCamOverlay = new GBV_CameraOverlay(context);
        }
