...
public class GBV_ChatProfile extends GBV_BaseActivity implements OnClickListener {
//    LinearLayout backmenu;
    byte[] bmyimage;
    GBV_DatabaseHelper dataBaseDetails;
    Switch online;
    String online1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gbv_activity_chat_profile);
        ...
        if (bundle != null) {
            ...
            this.online1 = getIntent().getExtras().getString("USER_ONLINE");
            this.typing1 = getIntent().getExtras().getString("USER_TYPING");
        }
        this.dataBaseDetails = new GBV_DatabaseHelper(this);
...
//        this.backmenu.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
//            case R.id.backmenu:
//                Intent intent = new Intent(GBV_ChatProfile.this, GBV_UserChat.class);
//                intent.putExtra("USER_ID", position);
//                intent.putExtra("USER_NAME", username);
//                intent.putExtra("USER_ONLINE", online1);
//                intent.putExtra("USER_TYPING", typing1);
...
//                return;
    ...
    private void SavaProfile() {
        ...
        startActivity(new Intent(this, GBV_MainFackChat.class));
        finish();
    }
